...
func _make_custom_tooltip(_for_text: String) -> Object:
	...
	tooltip.get_node("CanvasLayer/VBoxContainer/Label").text = str("Buy the second House")
	tooltip.get_node("CanvasLayer/VBoxContainer/Label2").text = str("Generate 2 gold / second")
